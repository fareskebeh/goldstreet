...
import { filterProps, maxGeneratorDuration } from "framer-motion";
...
const Register = () => {
  ...
  return (
    <div className="pt-24 flex flex-col sm:items-center justify-center h-[100dvh] p-6">
      <div className="">
        <p className="text-white text-5xl font-bold">Register for Gold Street</p>
        ...
        <form className="flex flex-col gap-3 py-4">
          ...
          />
          <input
            className="invalid:bg-red-900/30 border border-transparent transition duration-100 invalid:border-red-900 text-2xl outline-none text-white placeholder:text-neutral-600 p-4 rounded-xl bg-neutral-900/80"
            type="email"
            placeholder="Email"
          />
