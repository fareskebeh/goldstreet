...
const Community = () => {
  return (
    <div className="p-2 relative sm:p-30 lg:p-35 text-white">
      ...
      <ShinyText text="We have a Telegram channel in which we post trading insights and tips, daily scalping signals and trade breakdowns" disabled={false} speed={3} className='text-2xl sm:text-2xl md:text-3xl lg:text-4xl w-[50%] sm:w-auto' />
